...
subtitle: "RUG @ HDSI | `r verbaliseR::prettify_date('2022-09-29', uk_or_us = 'US')`"
from: markdown+emoji
format:
  revealjs: 
    transition: none
    ...
    footer: |
        Slides and recording: [cararthompson.com/talks/hdsi_rug](https://cararthompson.com/talks/hdsi-rug)
filters:
 - code-visibility
 - lightbox
lightbox: auto
...
## Seven tips for storytelling {auto-animate=true}
...
::: {.fragment}
- Start from a photo and use something like [imagecolorpicker.com](https://imagecolorpicker.com/) to pick out colours
![](https://www.researchgate.net/publication/262310666/figure/fig1/AS:296709688184842@1447752511115/a-Ripening-Stages-of-Banana-Fruit-1-7-Completely-unripe-to-completely-ripen.png)
:::
:::
::: {.column width=50%}
...
![](https://media.gcflearnfree.org/content/57f26593893b731320ed05db_10_03_2016/color_harmony_analog2.png)
:::
:::
:::
...
#| output-location: column-fragment
#| results: hide
#| code-line-numbers: "1-3|5-7|12-13"
...
## Seven tips for storytelling {background=#2C3D4F}
...
# Over to you! {background=#2C3D4F background-image=https://thumbs.gfycat.com/PerfumedDefinitiveChipmunk-size_restricted.gif}
